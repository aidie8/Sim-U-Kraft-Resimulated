...
public class SimukraftReloaded 
{
    ...
    public static void resetAndLoadNewWorld() {
        ...
        theFolks.clear();
        log.info("resetting folks"); 
        Building.initialiseAllBuildings();
        log.info("building intialized"); //load ALL buildings off disk and init them
        ...
        log.info("loading and spawned folk"); 
